from src.utils.transforms import (
    ...
    _axis_angle_rotation, matrix_to_quaternion, quaternion_to_axis_angle, axis_angle_to_quaternion, quaternion_to_matrix
)
import torch
import numpy as np
...
def transform_body_pose(pose, formats):
    ...
    # QUATERNION INPUTS
    elif formats == "quat->aa":
        pose = quaternion_to_axis_angle(pose)
    elif formats == "quat->rot":
        pose = quaternion_to_matrix(pose)
    elif formats == "quat->6d":
        pose = matrix_to_rotation_6d(quaternion_to_matrix(pose))
    ...
    # 6D INPUTS
        ...
        # matrot to quat 
        pose = matrix_to_quaternion(pose)
    ...
    elif formats in ['aa->aa', 'quat->quat', '6d->6d', 'rot->rot']: 
        pass 
